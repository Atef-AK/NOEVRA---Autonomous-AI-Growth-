  ...
  private async persistStep(
    ...
    return db.agentStep.create({
      data: {
        ...
        toolArgs: data.toolArgs !== undefined ? (JSON.parse(JSON.stringify(data.toolArgs)) as Prisma.InputJsonValue) : Prisma.JsonNull,
        toolResult: data.toolResult !== undefined ? (JSON.parse(JSON.stringify(data.toolResult)) as Prisma.InputJsonValue) : Prisma.JsonNull,
